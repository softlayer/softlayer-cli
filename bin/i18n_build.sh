...
# done
i18n4go -c extract-strings -v -o plugin/i18n/tmp_resources/ -d plugin  -r --ignore-regexp  ".*test.*" --output-match-package
i18n4go -c merge-strings -v -r -d plugin/i18n/tmp_resources/
# 
