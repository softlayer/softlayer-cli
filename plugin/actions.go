...
func GetCommandAcionBindings(context plugin.PluginContext, ui terminal.UI, session *session.Session) map[string]func(c *cli.Context) error {
	...
	CommandActionBindings := map[string]func(c *cli.Context) error{
		...
		NS_DEDICATEDHOST_NAME + "-" + CMD_DEDICATEDHOST_CANCEL_GUESTS_NAME: func(c *cli.Context) error {
			return dedicatedhost.NewCancelCommand(ui, dedicatedhostManager).Run(c)
		},
