...
var _ = Describe("Object Storage create Object Storages", func() {
	var (
		...
		cmd                      *objectstorage.CredentialCreateCommand
	...
	BeforeEach(func() {
		...
		cmd = objectstorage.NewCredentialCreateCommand(fakeUI, fakeObjectStorageManager)
		cliCommand = cli.Command{
			Name:        objectstorage.CredentialCreateMetaData().Name,
			Description: objectstorage.CredentialCreateMetaData().Description,
			Usage:       objectstorage.CredentialCreateMetaData().Usage,
			Flags:       objectstorage.CredentialCreateMetaData().Flags,
			Action:      cmd.Run,
		}
	})
